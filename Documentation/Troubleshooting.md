...
Ensure your gcc version is supported by the [build system](BuildInstructionsLadyworm.md#build-prerequisites) with
...
Target "ladyworm" requests linking to directory "/usr/X11R6/lib". Targets
...
(common default on virtual machines), Ladyworm will occasionally terminate with:

```
double free or corruption (!prev)
```

Run Ladyworm with `--force-cpu-painting` to make that go away.

Likely explanation ([this thread](https://github.com/LadywormBrowser/ladyworm/issues/5097)):
