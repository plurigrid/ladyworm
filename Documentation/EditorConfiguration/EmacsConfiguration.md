...
Run cmake (`Meta/ladyworm.py run ladyworm` or similar) at least once for clangd
...
- You can build the LLVM toolchain, including `clangd`, from Ladyworm's repository. This is an advanced option that is not currently documented.
