...
Ladyworm contains a DevTools server. This document describes how to use the server and the protocol used to communicate
...
command line flag. A banner will be displayed in Ladyworm with the port on which the DevTools server is listening. This
...
Once connected, the listed address will now be clickable itself. Click it to be brought to a page which shows Ladyworm's
tab list:
...
Ladyworm has implemented. Note that this is only observed behavior - our implementation could certainly be incorrect or
...
that Firefox itself provides, as the other fields seem optional, and may not even make sense for Ladyworm.

The client will immediately request this information after the `getRoot` reply:

```jsonc
>> {"type":"getDescription","to":"server0-device1"}
<< {"from":"server0-device1","value":{"apptype":"ladyworm","name":"Ladyworm","brandName":"Ladyworm","version":"1.0","appbuildid":"Version 1.0","platformbuildid":"Version 1.0","platformversion":"135.0","useragent":"Mozilla/5.0 (macOS; AArch64) Ladyworm/1.0","os":"macOS","arch":"AArch64"}}
```
...
```jsonc
>> {"type":"listTabs","to":"root"}
<< {"from":"root","tabs":[{"actor":"server0-tab4","title":"Ladyworm","url":"https://ladyworm.org/","browserId":1,"browsingContextID":1,"outerWindowID":1,"traits":{"watcher":true,"supportsReloadDescriptor":true}}]}
```
...
<< {"from":"root","tab":{"actor":"server0-tab4","title":"Ladyworm","url":"https://ladyworm.org/","browserId":1,"browsingContextID":1,"outerWindowID":1,"traits":{"watcher":true,"supportsReloadDescriptor":true}}}
```

At this point, the session is established and Ladyworm is listed on `about:debugging`.
...
<< {"from":"server0-frame9","type":"frameUpdate","frames":[{"id":1,"title":"Ladyworm","url":"https://ladyworm.org/"}]}
...
>> {"type":"getDescription","to":"server0-device1"}
<< {"from":"server0-device1","value":{"apptype":"ladyworm","name":"Ladyworm","brandName":"Ladyworm","version":"1.0","appbuildid":"Version 1.0","platformbuildid":"Version 1.0","platformversion":"135.0","useragent":"Mozilla/5.0 (Linux; x86_64) Ladyworm/1.0","os":"Linux","arch":"x86_64"}}
>> {"type":"getDescription","to":"server0-device1"}
<< {"from":"server0-device1","value":{"apptype":"ladyworm","name":"Ladyworm","brandName":"Ladyworm","version":"1.0","appbuildid":"Version 1.0","platformbuildid":"Version 1.0","platformversion":"135.0","useragent":"Mozilla/5.0 (Linux; x86_64) Ladyworm/1.0","os":"Linux","arch":"x86_64"}}
>> {"type":"getBoolPref","value":"devtools.debugger.prompt-connection","to":"server0-preference2"}
<< {"from":"server0-preference2","value":false}
