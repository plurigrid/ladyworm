# Ladyworm Browser process architecture
...
The Ladyworm web browser uses a multi-process architecture to improve stability and security in the face of arbitrary (and possibly hostile) web content.
