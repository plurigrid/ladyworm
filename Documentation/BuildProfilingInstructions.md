...
To add the flag, edit the `CMakeLists.txt` in the ladyworm root directory, and add `add_compile_options(-ftime-report)` to the list of compile options that start around line 220.
