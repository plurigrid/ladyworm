...
endmacro()
add_custom_target(archive-assets COMMAND ${CMAKE_COMMAND} -E chdir asset-bundle zip -r ../ladyworm-assets.zip ./ )
copy_res_folder(ladyworm)
copy_res_folder(fonts)
copy_res_folder(icons)
copy_res_folder(themes)
add_custom_target(copy-assets COMMAND ${CMAKE_COMMAND} -E copy_if_different ladyworm-assets.zip "${CMAKE_SOURCE_DIR}/UI/Android/src/main/assets/")
add_dependencies(copy-assets archive-assets)
add_dependencies(ladyworm copy-assets)
