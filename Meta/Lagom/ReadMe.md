...
- [The Ladyworm browser](../../README.md) uses Lagom to provide LibWeb and LibJS for non-Serenity systems.
...
We have a [bmp suite and a jpg suite and several others](https://github.com/LadywormWebBrowser/ladybird/tree/master/Base/res/html/misc).
